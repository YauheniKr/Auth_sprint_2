...
class TestsUserApi:
    ...
    def test_user_create(self):
        url = 'http://nginx/api/v1/auth/user/signup/'
        data = {
            'username': 'user111',
            'password': '12311',
            'email': 'fake@yamdb.ya'
    ...
    def test_user_update(self, users, tokens):
        url = 'http://nginx/api/v1/auth/user/me/'
    ...
    def test_user_login(self, users):
        url = 'http://nginx/api/v1/auth/user/login/'
        data = {
            'username': 'user1',
            'password': '123',
        }
    ...
    def test_user_logout(self, users, tokens, redis_session):
        url = 'http://nginx/api/v1/auth/user/logout/'
        access = tokens['access_token']
        headers = {
            'Authorization': f'Bearer {access}',
            'Content-Type': 'application/json'
    ...
    def test_user_refresh_token(self, users, tokens, redis_session):
        url = 'http://nginx/api/v1/auth/token/refresh/'
    ...
    def test_user_take_auth_history(self, users):
        ...
        url = 'http://nginx/api/v1/auth/user/history/'
        access = tokens['access_token']
        headers = {
            'Authorization': f'Bearer {access}',
            'Content-Type': 'application/json'
